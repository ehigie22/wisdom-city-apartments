  ...
  const linkSections = [
    {
      ...
      links: [
        ...
        { label: "Apartments", url: "/apartments" },
        { label: "About", url: "/about" },
        { label: "Contact Us", url: "/contact" }, // Updated to internal route
      ],
    },
    {
      title: "Follow Us",
    ...
    <div className="bg-slate-50 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div className="flex flex-col max-w-[420px]">
          ...
          {/* Description */}
          <p className="mt-5 text-sm text-gray-500 leading-relaxed">
            At Wisdom City Homes and Apartments, we offer luxury accommodations
            and unforgettable experiences, ensuring every guest enjoys comfort,
            style, and exceptional service throughout their stay.
          </p>
        </div>
